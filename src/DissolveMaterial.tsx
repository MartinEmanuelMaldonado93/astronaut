...
export type DissolveMaterialProps = {
...
export function DissolveMaterial({
	...
	const uniforms = useRef({
		...
		uColor: { value: new THREE.Color("#eb5a13").multiplyScalar(2) },
		uProgress: { value: 0 },
	});
	...
	useFrame((_state, delta) => {
		...
		uniforms.current.uProgress.value < 0.1 && onFadeOut();
	});

	return (
		<>
			<CSM
				baseMaterial={baseMaterial ?? THREE.MeshLambertMaterial}
